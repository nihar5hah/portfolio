...
export function ExperienceNew() {
  return (
    <section id="experience" className="section-padding bg-gradient-to-b from-background to-background-secondary/50 relative overflow-hidden">
      {/* Background grid */}
          ...
          <div className="space-y-0">
            {experiences.map((item: Experience, index: number) => {
              ...
              return (
                ...
                >
                  {/* Timeline dot - appears on scroll */}
                  <motion.div
                  ...
                  >
                    <motion.div
                      className="w-5 h-5 rounded-full bg-accent border-4 border-background shadow-lg shadow-accent/30"
